...
async function generatePromptWithExplanation({ dialogLog, gptReply, selectedMode }) {
  ...
  const thinkingModeDescriptions = {
    1: "現在の状況や用語の意味を整理し、事実を表層的に明らかにする問いを作成してください。構造分析や背景の深掘りは行わないでください。",
    2: "異なる立場や関係者の視点から状況を見直すことで、新しい理解を促す問いを構成してください。たとえば、他者・当事者・未来の自分など、視点の切り替えによって気づきが得られる問いにしてください。",
    3: "物事を構成する要素や仕組みを分解し、それらがどう関係し合っているかを考えさせる問いを構成してください。「なぜそうなっているのか」「何が影響しているのか」といった因果や構造の視点から深掘りできる問いにしてください。",
